...
juce::AudioProcessorValueTreeState::ParameterLayout layout;
  ...
  layout.add(std::make_unique<FloatParam>(
      "read_speed", "Read Speed", FloatRange(-4.f, 4.f, 0.000001f, 0.75f, true), 1.0f));
  layout.add(std::make_unique<FloatParam>(
      "buffer_size", "Buffer Size", FloatRange(0.0001f, 3.9f, 0.0001f, 0.3f), 1.f));
  layout.add(std::make_unique<FloatParam>(
      "feedback", "Feedback", FloatRange(0.0f, 1.0f, 0.00001f, 0.5f), 0.3f));
  layout.add(std::make_unique<FloatParam>(
    "read_offset", "Heads Offset", FloatRange(-1.f, 1.f, 0.00001f, 1.f), 0.f));
  layout.add(std::make_unique<FloatParam>(
      "head_ratio", "Head Ratio", FloatRange(-4.f, 4.f, 0.0001, 0.75, true), 1.f));
  layout.add(std::make_unique<FloatParam>(
